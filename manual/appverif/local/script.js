...
//       document.body.offsetHeight - (header.offsetHeight + 10);
//   else mainSection.style.height = 0;
...
//         if (vbDeclaration == "on") spanElements[i].style.display = "";
//         else spanElements[i].style.display = "none";
//       }
//       if (spanElements[i].codeLanguage == "VisualBasicUsage") {
//         if (vbUsage == "on") spanElements[i].style.display = "";
//         else spanElements[i].style.display = "none";
//       }
//       if (spanElements[i].codeLanguage == "CSharp") {
//         if (csLang == "on") spanElements[i].style.display = "";
//         else spanElements[i].style.display = "none";
//       }
//       if (spanElements[i].codeLanguage == "ManagedCPlusPlus") {
//         if (cLang == "on") spanElements[i].style.display = "";
//         else spanElements[i].style.display = "none";
//       }
//       if (spanElements[i].codeLanguage == "JSharp") {
//         if (jsharpLang == "on") spanElements[i].style.display = "";
//         else spanElements[i].style.display = "none";
//       }
//       if (spanElements[i].codeLanguage == "JScript") {
//         if (jsLang == "on") spanElements[i].style.display = "";
//         else spanElements[i].style.display = "none";
//       }
//       if (spanElements[i].codeLanguage == "JavaScript") {
//         if (jsLang == "on") spanElements[i].style.display = "";
//         else spanElements[i].style.display = "none";
//       }
...
//   if (value == null) vbDeclaration = "on";
//   else vbDeclaration = value;

//   value = Load("vbUsage");
//   if (value == null) vbUsage = "on";
//   else vbUsage = value;

//   value = Load("csLang");
//   if (value == null) csLang = "on";
//   else csLang = value;

//   value = Load("cLang");
//   if (value == null) cLang = "on";
//   else cLang = value;

//   value = Load("jsharpLang");
//   if (value == null) jsharpLang = "on";
//   else jsharpLang = value;

//   value = Load("jsLang");
//   if (value == null) jsLang = "on";
//   else jsLang = value;
// }
...
//     if (key.checked == true) inheritedMembers = "on";
//     else inheritedMembers = "off";

//     DisplayInheritedMembers();
//   }
//   if (key.id == "protectedCheckbox") {
//     if (key.checked == true) protectedMembers = "on";
//     else protectedMembers = "off";

//     DisplayProtectedMembers();
//   }
//   if (key.id == "netcfCheckbox") {
//     if (key.checked == true) netcfMembersOnly = "on";
//     else netcfMembersOnly = "off";
...
//   if (value == null) inheritedMembers = "on";
//   else inheritedMembers = value;

//   value = Load("protectedMembers");
//   if (value == null) protectedMembers = "on";
//   else protectedMembers = value;

//   value = Load("netcfMembersOnly");
//   if (value == null) netcfMembersOnly = "off";
//   else netcfMembersOnly = value;
// }
...
//   if (window.event.keyCode == 13) ExpandCollapse(imageItem);
// }

// function ExpandCollapseAll_CheckKey(imageItem) {
//   if (window.event.keyCode == 13) ExpandCollapseAll(imageItem);
// }
...
//     if (imageId == collapsedItems[i]) return true;
//   }
...
//   for (i = 0; i < collapsedItems.length; ++i) {
//     if (imageId == collapsedItems[i]) collapsedItems.splice(i, 1);
//   }
// }
...
//         if (
//           collapsedItem[collapsedItem.length - 1].previousSibling.firstChild !=
//           null
//         ) {
//           temp[temp.length] =
//             collapsedItem[
//               collapsedItem.length - 1
...
//   if (imageId == "toggleAllImage") return false;

//   toggleName = "procedureToggle";
//   if (imageId.indexOf(toggleName, 0) == 0) return false;
...
function ChangeCopyCodeIcon(key) {
  ...
  //       else imageElements[i].src = copyImage.src;
  //     }
  //   }
}

// function CopyCode_CheckKey(key) {
//   if (window.event.keyCode == 13) CopyCode(key);
// }
